    ...
    <section id="channels" className="relative z-10 px-5 py-24 sm:px-8 md:px-12">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-14 text-center">
          <Reveal delay={100}>
            <div className="inline-flex items-center gap-2 rounded-full border border-emerald-400/30 bg-emerald-400/10 px-4 py-1.5 font-mono text-xs uppercase tracking-[0.18em] text-emerald-300 backdrop-blur-xl">
          ...
          <Reveal delay={300}>
            <p className="mx-auto mt-4 max-w-2xl text-base text-zinc-300 sm:text-lg leading-relaxed">
        ...
        <Reveal delay={350} direction="scale">
          <div className="relative mb-8 overflow-hidden rounded-3xl border border-emerald-500/30 bg-gradient-to-br from-emerald-950/40 via-black/80 to-black p-6 sm:p-10 backdrop-blur-2xl shadow-glass-lg transition-colors duration-300 hover:border-emerald-400/50">
            ...
            <div className="relative z-10 flex flex-col items-start justify-between gap-6 lg:flex-row lg:items-center">
              <div className="flex items-start gap-4 sm:gap-5">
                <div className="flex h-14 w-14 sm:h-16 sm:w-16 shrink-0 items-center justify-center rounded-2xl border border-emerald-400/30 bg-emerald-400/10 text-emerald-300">
                  <MessageCircle size={32} />
                </div>
                <div>
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="rounded-md border border-emerald-400/30 bg-emerald-400/10 px-2 py-0.5 font-mono text-xs font-bold uppercase tracking-wider text-emerald-300">
                  ...
                  <p className="mt-1 text-sm sm:text-base text-zinc-300 max-w-xl">
                  ...
                  <div className="mt-3 rounded-2xl border border-hairline bg-overlay-soft p-3 w-fit backdrop-blur-xl">
                    <FounderCard compact />
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto">
                <a
                  ...
                  className="flex flex-1 lg:flex-none items-center justify-center gap-2 rounded-full bg-accent px-6 py-3.5 text-sm font-bold text-black transition-colors duration-300 hover:bg-emerald-300 shadow-glass"
                >
                  <Send size={15} />
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 rounded-full border border-hairline-raised bg-white/10 px-4 py-3.5 text-sm font-semibold text-white transition-colors duration-300 hover:bg-white/20"
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <Reveal delay={200} direction="up">
            <div className="group flex h-full flex-col justify-between rounded-2xl border border-hairline bg-overlay p-6 backdrop-blur-xl transition-colors duration-300 hover:border-red-500/50 hover:bg-black/80 hover:shadow-xl hover:shadow-red-500/10">
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-mono text-xs text-zinc-300">Video Content</span>
                </div>
          ...
          <Reveal delay={300} direction="up">
            <div className="group flex h-full flex-col justify-between rounded-2xl border border-hairline bg-overlay p-6 backdrop-blur-xl transition-colors duration-300 hover:border-pink-500/50 hover:bg-black/80 hover:shadow-xl hover:shadow-pink-500/10">
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-mono text-xs text-zinc-300">Visual Feed</span>
                </div>
          ...
          <Reveal delay={400} direction="up">
            <div className="group flex h-full flex-col justify-between rounded-2xl border border-hairline bg-overlay p-6 backdrop-blur-xl transition-colors duration-300 hover:border-sky-400/50 hover:bg-black/80 hover:shadow-xl hover:shadow-sky-400/10">
              <div>
                <div className="flex items-center justify-between">
                  <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-sky-400/30 bg-sky-500/15 text-sky-400 transition-transform duration-300 group-hover:scale-110">
                    <XIcon className="h-5 w-5 text-sky-400" />
                  </div>
                  <span className="font-mono text-xs text-zinc-300">Live Drops</span>
                </div>
          ...
          <Reveal delay={500} direction="up">
            <div className="group flex h-full flex-col justify-between rounded-2xl border border-hairline bg-overlay p-6 backdrop-blur-xl transition-colors duration-300 hover:border-blue-500/50 hover:bg-black/80 hover:shadow-xl hover:shadow-blue-500/10">
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-mono text-xs text-zinc-300">Leadership</span>
                </div>
